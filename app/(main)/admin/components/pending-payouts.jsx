                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h3 className="font-medium text-[#14967F]">
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[#14967F] font-medium">Doctor Information</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#14967F]">{selectedPayout.doctor.email}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
                      Specialty
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[#14967F] font-medium">Payout Details</h3>
                </div>
                <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20 space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#14967F] font-medium">
                  ...
                  <div className="border-t border-emerald-900/20 pt-3">
                    ...
                    <p className="text-[#14967F]">{selectedPayout.paypalEmail}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[#14967F] text-sm">
