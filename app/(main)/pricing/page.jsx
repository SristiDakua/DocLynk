  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="flex justify-start mb-2">
        <Link
          href="/"
          className="flex items-center text-muted-foreground hover:text-[#14967F] transition-colors"
        >
      ...
      <div className="max-w-3xl mx-auto mt-16 text-center">
        <h2 className="text-2xl font-bold text-[#14967F] mb-2">
          Questions? We're Here to Help
        </h2>
        <p className="text-muted-foreground mb-4">
          Contact our support team at support@Doclynk.com
        </p>
      </div>
    </div>
  );
