  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="border-emerald-900/20">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 bg-emerald-800/20">
                  {doctor.imageUrl ? (
                    <Image
                      src={doctor.imageUrl}
                      alt={doctor.name}
                ...
                <h2 className="text-xl font-bold text-[#14967F] mb-1">
                  Dr. {doctor.name}
                </h2>

                <Badge
                  variant="outline"
                  className="bg-emerald-800/20 border-emerald-900/30 text-emerald-400 mb-4"
                >
                  {doctor.specialty}
                </Badge>
      ...
      <div className="md:col-span-2 space-y-6">
        <Card className="border-emerald-900/20">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-[#14967F]">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[#14967F] font-medium">Description</h3>
              </div>
              <p className="text-muted-foreground [#14967F]space-pre-line">
                {doctor.description}
              </p>
            </div>

            <Separator className="bg-emerald-800/20" />

            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <Clock className="h-5 w-5 text-emerald-400" />
                <h3 className="text-[#14967F] font-medium">Availability</h3>
              </div>
              {totalSlots > 0 ? (
              ...
              <CardContent className="space-y-6">
                {totalSlots > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <h3 className="text-xl font-medium text-[#14967F] mb-2">
                      No available slots
                    </h3>
                    <p className="text-muted-foreground">
