...
export function DoctorEarnings({ earnings, payouts = [] }) {
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#14967F]">
                  {availableCredits}
                </p>
      ...
      <Card className="border-emerald-900/20">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-[#14967F] flex items-center">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-medium text-[#14967F]">
              ...
              {pendingPayout ? (
                ...
                <Badge
                  variant="outline"
                  className="bg-emerald-800/20 border-emerald-900/30 text-emerald-400"
                >
                  Available
                </Badge>
              )}
            ...
            {pendingPayout ? (
              <div className="space-y-2">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  <div>
                    ...
                    <p className="text-[#14967F] font-medium">
                  ...
                  <div>
                    ...
                    <p className="text-[#14967F] font-medium text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-[#14967F] font-medium">{availableCredits}</p>
                </div>
                <div>
          ...
          {payouts.length > 0 && (
            <div className="space-y-2">
              <h3 className="text-lg font-medium text-[#14967F]">Payout History</h3>
              <div className="space-y-2">
                    ...
                    <Badge
                      ...
                      className={
                        payout.status === "PROCESSED"
                          ? "bg-emerald-800/20 border-emerald-900/30 text-emerald-400"
      ...
      <Dialog open={showPayoutDialog} onOpenChange={setShowPayoutDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-xl font-bold text-[#14967F]">
              Request Payout
            </DialogTitle>
            <DialogDescription>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-[#14967F]">{availableCredits}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[#14967F]">-${platformFee.toFixed(2)}</span>
              </div>
              <div className="border-t border-emerald-900/20 pt-2 flex justify-between font-medium">
                <span className="text-[#14967F]">Net payout:</span>
