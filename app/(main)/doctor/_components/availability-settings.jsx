    ...
    <Card className="border-emerald-900/20">
      ...
      <CardContent>
        ...
        {!showForm ? (
          <>
            <div className="mb-6">
              <h3 className="text-lg font-medium text-[#14967F] mb-3">
          ...
          >
            <h3 className="text-lg font-medium text-[#14967F] mb-2">
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-emerald-900/10 rounded-md">
          <h4 className="font-medium text-[#14967F] mb-2 flex items-center">
